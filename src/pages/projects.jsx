...
const projects = [
  {
    name: 'BasedLabs',
    description:
      'My first successful startup, I learned a lot and have a lot to share. It currently makes $50k MRR.',
    link: { href: 'https://basedlabs.ai', label: 'basedlabs.ai' },
    logo: logoPlanetaria,
  },
  {
    name: 'BasedTools',
    description:
      'A project I built to fuel our distribution engine. Its an AI tools directory.',
    link: { href: 'https://basedtools.ai', label: 'basedtools.ai' },
    logo: logoPlanetaria,
  },
  {
    name: 'Motionbox',
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Projects - Michael Aubry</title>
        <meta
          name='description'
